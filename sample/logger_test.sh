...
clog_debug '这是一条 DEBUG 日志' ## 不显示 
clog_info '这是一条 INFO 日志'
clog_warn '这是一条 WARN 日志'
clog_error '这是一条 ERROR 日志'
clog_success '这是一条 SUCCESS 信息'

print ''
clog_info '修改日志等级为 DEBUG'
__LOGGER_LOG_LEVEL__=$__LOGGER_LEVEL_DEBUG__
log_debug '这是一条 DEBUG 日志' ## 此时会显示
clog_debug '这是一条 DEBUG 日志' ## 此时会显示
